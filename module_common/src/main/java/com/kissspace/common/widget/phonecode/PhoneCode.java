package com.kissspace.common.widget.phonecode;
...
public class PhoneCode extends RelativeLayout implements IPhoneCode {
    ...
    //输入框默认背景
    private Drawable tvBgNormal = getResources().getDrawable(R.drawable.common_verify_rectangel_bg_normal);
    //输入框焦点背景
    private Drawable tvBgFocus = getResources().getDrawable(R.drawable.common_verify_rectangle_bg_focus);
    //是否设置了自定义默认背景
    ...
    public PhoneCode(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < typedArray.getIndexCount(); i++) {
            ...
            if (attr == R.styleable.PhoneCode_codeLength) {
                ...
                //默认背景
                int mtvBgNormal = typedArray.getResourceId(attr, R.drawable.common_verify_rectangel_bg_normal);
                tvBgNormal = getResources().getDrawable(mtvBgNormal);
                isSetTvBgNormal = true;
            } else if (attr == R.styleable.PhoneCode_bgFocus) {
                //焦点背景
                int mtvBgFocus = typedArray.getResourceId(attr, R.drawable.common_verify_rectangle_bg_focus);
    ...
    private void initTvBg() {
        ...
        if (!isSetTvBgNormal) {
            ...
            if (tvBgStyle == 1001)//圆圈
                mtvBgNormal = R.drawable.common_verify_oval_bg_normal;
            else if (tvBgStyle == 1002) //下划线
                mtvBgNormal = R.drawable.common_verify_line_bg_normal;
            else //方框
                mtvBgNormal = R.drawable.common_verify_rectangel_bg_normal;
        ...
        if (!isSetTvBgFocus) {
            int mtvBgFocus;
            if (tvBgStyle == 1001) //圆圈
                mtvBgFocus = R.drawable.common_verify_oval_bg_focus;
            else if (tvBgStyle == 1002)//下划线
                mtvBgFocus = R.drawable.common_verify_line_bg_focus;
            else//方框
                mtvBgFocus = R.drawable.common_verify_rectangle_bg_focus;
...
//    }
    ...
    public void setBgNormal(Drawable tvBgNormal) {
        if (tvBgNormal != null) {
            ...
            this.tvBgNormal = getResources().getDrawable(R.drawable.common_verify_rectangel_bg_normal);
        }
        tvSetFocus();
    }
