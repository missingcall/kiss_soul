...
class ZegoExpressConvert {
  public:
    ...
    //     ZegoStrncpy(oResource.common_resource_path, resource.commonResourcePath.c_str(),
    //                 ZEGO_EXPRESS_MAX_URL_LEN);
    //     oResource.media_data_resource_buffer = resource.mediaDataResourceBuffer;
    //     oResource.media_data_resource_buffer_length = resource.mediaDataResourceBufferLength;
    //     oResource.copyrighted_music_resource_id = resource.copyrightedMusicResourceID;

    //     return zego_media_player_resource;
    // }
};
