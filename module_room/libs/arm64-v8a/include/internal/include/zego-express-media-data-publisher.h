...
///
/// @param instance_index [in/out] Media data publisher instance, -1 will be returned when the maximum number is exceeded.
ZEGOEXP_API zego_error EXP_CALL zego_express_create_media_data_publisher(int *instance_index);
