...
import com.kissspace.util.grantReadUriPermission
import com.kissspace.util.insertMediaImage
...
open class CropPictureContract : ActivityResultContract<CropPictureRequest, Uri>() {
  ...
  override fun createIntent(context: Context, input: CropPictureRequest): Intent {
    outputUri = input.outputUri ?: context.contentResolver.insertMediaImage()
